...
{-
  Equational theory for the two kinds of cuts -- associativity.
-}

module Dinaturality.CutAssociativity where
...
-- Helper used to get rid of functor compositions for the main theorem.
...
assoc-nat-din-nat : ∀ {Δ Γ : Category o ℓ e}
  ...
  → {γ : DinaturalTransformation {C = Δ ⊗ Γ} (SetA.-×- ∘F (P ∘F (v1 ∘F ctr  ※ v1 ∘F cov) ※ Φ)) (Q ∘F (v1 ∘F ctr  ※ v1 ∘F cov))}
  → {β : DinaturalTransformation {C = op Δ ⊗ Δ ⊗ Γ}
                            (SetA.-×- ∘F (Q ∘F (v1 ∘F cov ※ v2 ∘F cov) -- v1 and v2 only covariant
                                       ※ Φ ∘F ((v2 ∘F ctr  ※ v3 ∘F ctr ) ※ v1 ∘F ctr  ※ v3 ∘F cov))) -- v1 and v2 only ctr variant
                            (R ∘F ((v1 ∘F cov ※ v3 ∘F ctr ) ※ v2 ∘F cov ※ v3 ∘F cov))} -- v1 and v2 only covariant
  → (let -- weakening of β to add P as one of the hypotheses (since cuts require the same Φ)
         β′ : DinaturalTransformation {C = op Δ ⊗ Δ ⊗ Γ}
                (SetA.-×- ∘F (Q ∘F (v1 ∘F cov ※ v2 ∘F cov) ※
                  (SetA.-×- ∘F (P ∘F (v1 ∘F ctr  ※ v1 ∘F cov) ※ Φ)) ∘F
                  ((v2 ∘F ctr  ※ v3 ∘F ctr ) ※ v1 ∘F ctr  ※ v3 ∘F cov)))
                (R ∘F ((v1 ∘F cov ※ v3 ∘F ctr ) ※ v2 ∘F cov ※ v3 ∘F cov))
         β′ = β ∘> weaken-helper {Φ = Φ} {P = P} {Q = Q})
  →  cut-din {Φ = Φ} {Q = R} {P = P} α
      (cut-nat {Φ = (SetA.-×- ∘F (P ∘F (v1 ∘F ctr  ※ v1 ∘F cov) ※ Φ))} {Q = R} {P = Q} γ β′)
  ≃ᵈ cut-nat {Φ = Φ} {Q = R} {P = Q}
       (cut-din {Φ = Φ} {Q = Q ∘F (v1 ∘F ctr  ※ v1 ∘F cov)} {P = P} α γ) β
...
----------------------------- Helpers used in more than one function ---------------------------
